...
def get_V(actor_state, params, observations, subkey):
    ...
    return qf_next_target_values - 0.001 * log_prob.reshape(-1, 1)
...
def train_step(agent_state):
    ...
    def update_critic(
        ...
        def mse_loss(params):
            ...
            chi2_loss =((1-Policy_Batch.dones)*args.reg_mult*(reward1 ** 2)).mean()
            loss += chi2_loss
    ...
    def update_actor(
        ...
        def actor_loss(params):
            ...
            actor_loss = ((0.001  * log_prob - min_qf_pi.squeeze(-1))).mean()
