...
def parse_args():
    ...
    parser.add_argument("--expert-data", type=str, default="expert_data/HalfCheetahWithObstacle",
...
if __name__ == "__main__":
    ...
    state=checkpointer.restore("sacpolicy/HalfCheetahWithObstacle/HalfCheetahWithObstacle__test_remove__1__169466659114", item=state)
