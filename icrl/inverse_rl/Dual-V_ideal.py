...
if __name__ == "__main__":
    ...
    def update_critic(
        ...
        def mse_loss(params):
            ...
            loss = ((expert_current_Q.reshape(-1) - expert_discounted_rewards)**2).mean()+((policy_current_Q.reshape(-1) - policy_discounted_rewards)**2).mean()
    ...
    def update_value_critic(
        ...
        def mse_loss(params):
            ...
            loss=((1-lamb)*(current_V)+lamb*(((current_Q-current_V)+0.25*(current_Q-current_V)**2).clip(0))).mean()
