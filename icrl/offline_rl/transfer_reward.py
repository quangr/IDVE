...
def solve_V(grid_shape, expert_trajs, end_point, sample_trajs, gamma, beta,lamb,ad_min):
...
def resolve_V(grid_shape, expert_trajs, end_point, sample_trajs, gamma, beta,V):
    target_E,target_S,show_S,r_E,r_S,obs_E,obs_next_E,obs_S,obs_next_S,d_end = get_data(grid_shape, expert_trajs, end_point, sample_trajs, gamma, beta)
...
# lambs=np.linspace(0.4, 0.55, 4)
# ad_mins=[0,-1,-2,float("-inf")]
# result={}
# for ad_min in ad_mins:
#     for lamb in lambs:
#         reward_V,V=solve_V(grid_shape, expert_trajs, end_point, sample_trajs, gamma, beta,lamb,ad_min)
#         result[(ad_min,lamb)]=(reward_V,V)
# checkpointer = orbax.checkpoint.PyTreeCheckpointer()
# save_args = orbax_utils.save_args_from_target(result)
# checkpointer.save(f"grid_img/paper/lamb/{settingname}",result, save_args=save_args)

lamb = 0.4
reward_V,V=solve_V(grid_shape, expert_trajs, end_point, sample_trajs, gamma, beta,lamb,0)
...
# checkpointer.save(f"grid_img/paper/abalation/{settingname}",(V,reward_V,new_reward_V), save_args=save_args)
